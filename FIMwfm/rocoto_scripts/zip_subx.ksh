...
dd=${DAY}
hh=${HOUR}
mssdir=/ESRL/BMC/fim/5year/Shan.Sun/subx_rt_FIMr1.1/${yyyy}
...
echo "to hpss $zipfile $ncfile $mssdir"
htar -cPvf $mssdir/fim${GLVL}_${yyyy}${mm}${dd}${hh}.nc $ncfile
htar -cPvf $mssdir/$zipfile $zipfile
