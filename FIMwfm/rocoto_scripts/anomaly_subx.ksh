...
date=${DAY}${mon}${YEAR}
flnm=FIM_${date}_00z_d01_d32
echo "date = $date hr = $HH flnm = $flnm"

day=${YEAR}${MM}${DAY}

cd ${NC_SUBX_DIR}

if [[ $HH -eq 6 && -f zg_500_${flnm}_m01.nc && -f zg_500_${flnm}_m02.nc && -f zg_500_${flnm}_m03.nc && -f zg_500_${flnm}_m04.nc ]]; then
  ...
  echo " grep 3 fields "
    ncks -h -A zg_500_${flnm}_m01.nc $file1
    ncks -h -A zg_500_${flnm}_m02.nc $file2
    ncks -h -A zg_500_${flnm}_m03.nc $file3
    ncks -h -A zg_500_${flnm}_m04.nc $file4

    ncks -h -A tas_2m_${flnm}_m01.nc $file1
    ncks -h -A tas_2m_${flnm}_m02.nc $file2
    ncks -h -A tas_2m_${flnm}_m03.nc $file3
    ncks -h -A tas_2m_${flnm}_m04.nc $file4

    ncks -h -A pr_sfc_${flnm}_m01.nc $file1
    ncks -h -A pr_sfc_${flnm}_m02.nc $file2
    ncks -h -A pr_sfc_${flnm}_m03.nc $file3
    ncks -h -A pr_sfc_${flnm}_m04.nc $file4
  ...
  cd $wdir
   ...
   ncap2 -h -O -s "r12D=r12D*86400"   tmp2.nc $ens
...
# done anomaly; clean-up
    echo " rmdir $wdir "
    /bin/rm $wdir ${NC_SUBX_DIR}/*${flnm}*.nc
